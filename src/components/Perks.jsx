  ...
  const handleCbClick = (e) => {
	...
	return (
		<>
			...
			<label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
				<input type="checkbox" checked={selected.includes('heatcool')} name="heatcool" onChange={(handleCbClick)} />
				<span>Heating and cooling systems</span>
			</label>
			<label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
				<input type="checkbox" checked={selected.includes('outdoor')} name="outdoor" onChange={(handleCbClick)} />
			...
			<label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
				<input type="checkbox" checked={selected.includes('recreation')} name="recreation" onChange={(handleCbClick)} />
